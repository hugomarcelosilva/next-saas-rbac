...
- [ ] It should be able to recover passwords using e-mail;
...
- [ ] It should be able to get billing details for an organization ($20 per project / $10 per member excluding billing role);
...
- Members can leave their organization;